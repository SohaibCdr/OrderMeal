  ...
  return (
    <nav className="flex w-full bg-white shadow-md mt-2 lg:mt-0 z-20 items-center ">
      <div className="container mx-auto flex items-center justify-between px-6 flex-wrap ">
        ...
        {/* Center: Logo */}
        <div className="flex items-center gap-2 mb-4 md:mb-0 lg:mr-[245px]  lg:ml-0 ml-[20px]">
          <Link to="/">
            <img src={logo} alt="logo" className="w-[60px]" />
          </Link>
          <h1 className="font-bold text-2xl font-serif tracking-wide">ORDER MEAL</h1>
        </div>
        <div className="flex items-center gap-4 mb-4 md:mb-0  mr-[390px]  lg:ml-0 ml-[20px]">
          <NavLink
            to="/"
            end
            className={({ isActive }) =>
        ...
        {/* Right: Icons */}
        <div className="flex items-center gap-5 mb-4 lg:mb-0  lg:ml-0 ml-[110px]">
